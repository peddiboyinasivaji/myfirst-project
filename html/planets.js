...
{
    images[i-1].setAttribute("src","../a/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval=0;
    document.getElementById("header").style.backgroundImage="url(../a/"+imagesarr[indval]+")"
    }
    else
    {
        document.getElementById("header").style.backgroundImage="url(../a/"+imagesarr[indval]+")" 
...
function dec()
{
 ...
 function openImg(pic,name,info)
 {
    ...
    document.getElementById("subWindowImg").src='../a/'+pic+".jpg"
